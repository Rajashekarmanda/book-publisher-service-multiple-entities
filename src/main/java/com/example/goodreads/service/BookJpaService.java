...
public class BookJpaService implements BookRepository {
    ...
    public Book addBook(Book book) {
        ...
        try {
            Publisher publisherDetails = publisherJpaRepository.findById(publisherId).get();
            book.setPublisher(publisherDetails);
    ...
    public Book updateBook(int bookId, Book book) {
        try {
            ...
            if (book.getPublisher() != null) {
                Publisher publisherDetails = publisherJpaRepository.findById(book.getPublisher().getPublisherId())
                        .get();
                newBook.setPublisher(publisherDetails);
            }
